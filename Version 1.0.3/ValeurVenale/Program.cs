                    ...
                    if(LivingSpaceSurface[i] != 0)
                    {
                        ...
                        if (Tc != 0)
                        {
                            ...
                            if (Types[i] == 1)
                            {
                                ...
                                if (Conditions[i] == "ConditionNeedsImprovement") // aspectul neplacut al casei daca trebuie refacuta scade valoarea 
                                {
                                    Values = Values - 6000;
                                }
                                if(Basements[i] == "on")
            ...
            {   // Open the text file using a stream reader.
                using (StreamReader sr = new StreamReader("C:\\Users\\Madalin\\Desktop\\ValeurVenale\\property.txt"))
                {
                    ...
                    while (line != null)
                    {
                        ...
                        if (line.Contains("CheckOutsideFeaturesYard"))
                        {
                            words = line.Split('"');
